    ...
    <div class="container">
        ...
        <form action="" method="POST" enctype="multipart/form-data" >
            <p>
                ...
                <input id="num_one" name="number_one" value="" type="number" placeholder="put (number)" required>
            </p>
            <p>
                <label for="num_two">Enter Number two: </label>
                <input id="num_two" name="number_two" value="" type="number" placeholder="put (number)" required>
            </p>
            <div class="btn">
